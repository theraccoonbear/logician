...
export function HexTile({
  ...
  return (
    ...
    <div className={`hex-slot ${selected ? 'is-selected' : ''}`}>
      {/* Fake tile thickness: the same terrain art, darkened and offset down-right, painted
          ...
          sliver ends up visible, reading as the die-cut edge of this same piece of material
          rather than a generic drop shadow. */}
      <img className="hex-tile-bevel" src={terrainArtUrl(hex.terrain)} alt="" />
